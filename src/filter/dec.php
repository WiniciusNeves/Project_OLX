...
<body>
    ...
    <aside>
        <div class="container-aside">
            ...
            <div class="box" id="box2">
                <a href="#" style="text-decoration: none; "><img src="../public/images/2.png" width="50" height="50" alt="" style="margin-left: 10px;">
                    <ul style="list-style-type: none; padding: 0; margin: 0">
                        <li>decoração</li>
                    </ul>
                </a>
            ...
            <div class="box" id="box3">
                <a href="car.php" style="text-decoration: none;"><img src="../public/images/3.png" width="50" height="50" alt="">
                    <ul style="list-style-type: none; padding: 0; margin: 0">
                        <li>Veiculos</li>
                    </ul>
                </a>
    ...
    <main>
        ...
        <div class="container-main">
            ...
            $sql = "SELECT * FROM posts WHERE category = 'decoracao' ORDER BY id DESC";
