        ...
        <div class="container-aside">
            <div class="categories">
                <div class="box" id="box1">
                    <a href="filter?category=1"><img src="./public/images/1.png" width="50" height="50" alt="" style="margin-left: 8px;"></a>
                    <ul style="list-style-type: none; padding: 0; margin: 0">
                        <li>tecnologia</li>
                    </ul>
                </div>
                <div class="box" id="box2">
                    <a href="filter?category=2"><img src="./public/images/2.png" width="50" height="50" alt="" style="margin-left: 10px;"></a>
                    <ul style="list-style-type: none; padding: 0; margin: 0">
                        <li>decoração</li>
                    </ul>
                </div>
                <div class="box" id="box3">
                    <a href="filter?category=3"><img src="./public/images/3.png" width="50" height="50" alt=""></a>
                    <ul style="list-style-type: none; padding: 0; margin: 0">
                        <li>Veiculos</li>
                    </ul>
                </div>
