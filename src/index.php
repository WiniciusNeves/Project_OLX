    ...
    <aside>
        <div class="container-aside">
            <div class="categories"">
                ...
                <a href="./filter/tec.php?search=tecnologia" style="text-decoration: none; "><img src="./public/images/1.png" width="50" height="50" alt="" style="margin-left: 8px;">
            ...
            <div class="box" id="box2">
                <a href="./filter/dec.php?search=decoração" style="text-decoration: none; "><img src="./public/images/2.png" width="50" height="50" alt="" style="margin-left: 10px;">
                    <ul style="list-style-type: none; padding: 0; margin: 0">
                        <li>decoração</li>
                    </ul>
                </a>
            ...
            <div class="box" id="box3">
                <a href="./filter/car.php?search=veiculos" style="text-decoration: none;"><img src="./public/images/3.png" width="50" height="50" alt="">
                    <ul style="list-style-type: none; padding: 0; margin: 0">
                        <li>Veiculos</li>
                    </ul>
                </a>
        ...
        <div class="container-main">
            ...
            <span style="font-size: 20px; font-weight: bold; color: rebeccapurple; text-decoration: none; position: relative; top: 100px; left: 80px">
                ...
                if (isset($_SESSION['name'])) {
                    echo '<a href="?' . htmlspecialchars($_SESSION['id'], ENT_QUOTES, 'UTF-8') . '&anunciar"><input type="button" value="Adicionar anuncio"></a>';
